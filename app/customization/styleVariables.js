// =================================BACKGROUND=================================
export const background = 'url("https://hdwallsource.com/img/2014/9/light-gradient-wallpaper-26039-26724-hd-wallpapers.jpg") no-repeat center center';
...
export const strongTextColor = primaryColor;
export const maskColor = 'rgba(#000,0.8)';
export const chatBGColor = '#fff';
export const helpBGColor = '#869cb2';
export const chatBorderColor = '#eeeeee';
...
export const botAvatarIcon = 'http://www.freeiconspng.com/uploads/customer-service-icon-png-9.png';
...
export const inputBorderColor = '#e5e5e5';
